...
@testset "Jin-Xin 2D" begin
    ...
    compare_errors_txt(sol, data_name; overwrite_errors = overwrite_errors, tol = 1e-8)
...
@testset "Burg sin smooth 2D" begin
    ...
    trixi_include(joinpath(cRK_examples_dir(), "2d", "run_burg2d_smooth_sin.jl"),
                  ...
                  solver = cIMEX111(),
                  degree = 0,
                  animate = false, final_time = 0.1, nx = 10, ny = 10)
    data_name = "burg2d_smooth_sin_cimex111.txt"
    compare_errors_txt(sol, data_name; overwrite_errors = overwrite_errors)
end

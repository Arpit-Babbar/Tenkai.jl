...
trixi_include(joinpath(@__DIR__, "run_rayleight_taylor.jl"), nx = 5, solver = "lwfr", blend_type = :mh,
                       cfl = 0.0, degree = 3, final_time = 0.1)
# Run again after compilation!
sol = trixi_include(joinpath(@__DIR__, "run_rayleight_taylor.jl"), nx = 64, solver = "lwfr", blend_type = :mh,
...
trixi_include(joinpath(@__DIR__, "run_double_mach_reflection.jl"), ny = 5, solver = "lwfr", blend_type = :mh,
                       cfl = 0.0, degree = 3, final_time = 0.02)
# Run again after compilation!
sol = trixi_include(joinpath(@__DIR__, "run_double_mach_reflection.jl"), ny = 150, solver = "lwfr", blend_type = :mh,
...
trixi_include(joinpath(@__DIR__, "run_hurricane_v0critical.jl"), ny = 5, nx = 5, solver = "lwfr", blend_type = :mh,
                       cfl = 0.0, degree = 3, final_time = 0.0045)
# Run again after compilation!
sol = trixi_include(joinpath(@__DIR__, "run_hurricane_v0critical.jl"), ny = 200, nx = 200, solver = "lwfr", blend_type = :mh,
...
trixi_include(joinpath(@__DIR__, "run_rp2d_12.jl"), ny = 5, nx = 5, solver = "lwfr", blend_type = :mh,
                       cfl = 0.0, degree = 3, final_time = 0.0045)
# Run again after compilation!
sol = trixi_include(joinpath(@__DIR__, "run_rp2d_12.jl"), ny = 512, nx = 512, solver = "lwfr", blend_type = :mh,

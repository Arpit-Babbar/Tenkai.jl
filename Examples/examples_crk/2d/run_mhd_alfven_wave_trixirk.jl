...
# solver = TrixiRKSolver(Tenkai.VolumeIntegralFluxDifferencing(volume_flux))
# solver = TrixiRKSolver()
...
#         trixi_ode = Tenkai.tenkai2trixiode(TrixiRKSolver(), equation, problem,
#                                     scheme_trixi, param))

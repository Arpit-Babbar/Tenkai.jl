...
@inline @inbounds function double_mach_reflection_bv(x::Real, y::Real, t::Real)
   ...
   ρ_v1 = ρ*v1
   ρ_v2 = ρ*v2
   return SVector{4,Float64}(ρ, ρ_v1, ρ_v2, p/(γ-1.0) + 0.5*(ρ_v1*v1+ρ_v2*v2))
end
...
function kh_iv(x, y)
   ...
   ρ_v1 = rho*v1
   ρ_v2 = rho*v2
   return SVector(rho, rho*v1, rho*v2, p/(γ-1.0) + 0.5*(ρ_v1*v1+ρ_v2*v2))
end
...
function eigmatrix(eq::Euler2D, U)
   ...
   M21 = u;      M22 = 0;  M23 = u+c;   M24 = u-c;
   M31 = v;      M32 = -1; M33 = v;     M34 = v;
   M41 = 0.5*q2; M42 = -v; M43 = h+c*u; M44 = h-c*u;
   ...
   M11 = 1;      M12 = 0;  M13 = 1;     M14 = 1;
   M21 = u;      M22 = 1;  M23 = u;     M24 = u;
   M31 = v;      M32 = 0;  M33 = v+c;   M34 = v-c;
   M41 = 0.5*q2; M42 = u;  M43 = h+c*v; M44 = h-c*v;
   ...
   M11 = 1-phi2/c2;       M12 = g1*u/c2;       M13 = g1*v/c2;    M14 = -g1/c2;
   M21 = v;               M22 = 0;             M23 = -1;         M24 = 0;
   M31 = beta*(phi2-c*u); M32 = beta*(c-g1*u); M33 = -beta*g1*v; M34 = beta*g1;
   M41 = beta*(phi2+c*u); M42 =-beta*(c+g1*u); M43 = -beta*g1*v; M44 = beta*g1;
   ...
   M11 = 1-phi2/c2;       M12 = g1*u/c2;       M13 = g1*v/c2;       M14 = -g1/c2;
   M21 = -u;              M22 = 1;             M23 = 0;             M24 = 0;
   M31 = beta*(phi2-c*v); M32 =-beta*g1*u;     M33 = beta*(c-g1*v); M34 = beta*g1;
   M41 = beta*(phi2+c*v); M42 =-beta*g1*u;     M43 =-beta*(c+g1*v); M44 = beta*g1;
